...
func publicIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "public/index.html", size: 2347, mode: os.FileMode(436), modTime: time.Unix(1508982264, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
